...
3. Calibrate the RC using ```bash cr ```command in the command line interface.
...
To disarm, use the ```bash disarm ``` command, or move the throttle stick to the bottom left position:
